...
namespace FinalProject.Controllers
{
    ...
    public class PrivateChatController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetChat([FromQuery] int? chatId)
        {
            ...
            if (chat.UserOne.ImageUrl != null && !(chat.UserOne.ImageUrl.Contains(@"Resources\Images\")))
            {
                chat.UserOne.ImageUrl = @"Resources\Images\" + chat.UserOne.ImageUrl;
            }
            if (chat.UserOne.ImageUrl == null)
            {
                chat.UserOne.ImageUrl = @"Resources\Images\defPerson.jpg";
            }
            if (chat.UserTwo.ImageUrl != null && chat.UserTwo.ImageUrl.Contains(@"Resources\Images\"))
            {
                chat.UserTwo.ImageUrl = @"Resources\Images\" + chat.UserTwo.ImageUrl;
            }
            if (chat.UserTwo.ImageUrl == null)
            {
                chat.UserTwo.ImageUrl = @"Resources\Images\defPerson.jpg";
            }
            return Ok(chat);
        }
        ...
        public async Task<IActionResult> GetAll([FromQuery] string userId)
        {
            ...
            {
                if (item.UserOne.ImageUrl != null)
                {
                    item.UserOne.ImageUrl = @"Resources\Images\" + item.UserOne.ImageUrl;
                }
                if(item.UserOne.ImageUrl == null)
                {
                    item.UserOne.ImageUrl = @"Resources\Images\defPerson.jpg";
                }
                if (item.UserTwo.ImageUrl != null)
                {
                    item.UserTwo.ImageUrl = @"Resources\Images\" + item.UserTwo.ImageUrl;
                }
                if (item.UserTwo.ImageUrl == null)
                {
                    item.UserTwo.ImageUrl = @"Resources\Images\defPerson.jpg";
                }
            }
            return Ok(chats);
        }
